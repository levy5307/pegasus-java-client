...
public class negotiation_request implements com.xiaomi.infra.pegasus.thrift.TBase<negotiation_request, negotiation_request._Fields>, java.io.Serializable, Cloneable, Comparable<negotiation_request> {
  private static final com.xiaomi.infra.pegasus.thrift.protocol.TStruct STRUCT_DESC = new com.xiaomi.infra.pegasus.thrift.protocol.TStruct("negotiation_request");
  ...
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new negotiation_requestStandardSchemeFactory();
  private static final com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new negotiation_requestTupleSchemeFactory();
  ...
  static {
    ...
    com.xiaomi.infra.pegasus.thrift.meta_data.FieldMetaData.addStructMetaDataMap(negotiation_request.class, metaDataMap);
  }
  ...
  private static class negotiation_requestStandardSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public negotiation_requestStandardScheme getScheme() {
      return new negotiation_requestStandardScheme();
    }
  }

  private static class negotiation_requestStandardScheme extends com.xiaomi.infra.pegasus.thrift.scheme.StandardScheme<negotiation_request> {

    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol iprot, negotiation_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol oprot, negotiation_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
      struct.validate();
  ...
  private static class negotiation_requestTupleSchemeFactory implements com.xiaomi.infra.pegasus.thrift.scheme.SchemeFactory {
    public negotiation_requestTupleScheme getScheme() {
      return new negotiation_requestTupleScheme();
    }
  }

  private static class negotiation_requestTupleScheme extends com.xiaomi.infra.pegasus.thrift.scheme.TupleScheme<negotiation_request> {

    @Override
    public void write(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, negotiation_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
    ...
    @Override
    public void read(com.xiaomi.infra.pegasus.thrift.protocol.TProtocol prot, negotiation_request struct) throws com.xiaomi.infra.pegasus.thrift.TException {
